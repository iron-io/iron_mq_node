...
(function() {
  ...
  APIClient = (function(_super) {
    ...
    APIClient.prototype.messagesDelete = function(queue_name, options, cb) {
    ...
    APIClient.prototype.messagesTouch = function(queue_name, message_id, cb) {
      ...
      body = _.pick(options, 'reservation_id');
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.post("/" + queue_name + "/messages/" + options.message_id + "/touch", body, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };
    ...
    APIClient.prototype.messagesRelease = function(queue_name, message_id, options, cb) {
      ...
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.post("/" + queue_name + "/messages/" + options.message_id + "/release", body, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };
