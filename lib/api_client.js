...
(function() {
  ...
  APIClient = (function(_super) {
    ...
    APIClient.prototype.messagesTouch = function(queue_name, message_id, reservation_id, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.post("/" + queue_name + "/messages/" + message_id + "/touch", {
    ...
    APIClient.prototype.messagesRelease = function(queue_name, message_id, reservation_id, options, cb) {
      var body, parseResponseBind;
