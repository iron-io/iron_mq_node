...
(function() {
  ...
  Client = (function() {
    var prepareIdsToRemove, prepareQueueOptions, prepareSubscribers;
    ...
    Client.prototype.create_queue = function(queue_name, options, cb) {
      ...
      return this.api.queuesCreate(queue_name, options, function(error, body) {
        if (error == null) {
    ...
    Client.prototype.update_queue = function(queue_name, options, cb) {
      options = prepareQueueOptions(options);
      return this.api.queuesUpdate(queue_name, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
    ...
    Client.prototype.add_alerts = function(alerts, cb) {
      ...
      return this.api.queuesAddAlerts(this.api.options.queue_name, {
        alerts: alerts
      }, function(error, body) {
        if (error == null) {
          return cb(error, body);
    ...
    Client.prototype.del = function(options, cb) {
      return this.api.messagesDelete(this.api.options.queue_name, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
    ...
    Client.prototype.msg_touch = function(options, cb) {
      return this.api.messagesTouch(this.api.options.queue_name, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
    ...
    Client.prototype.msg_release = function(options, cb) {
      return this.api.messagesRelease(this.api.options.queue_name, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
    ...
    prepareQueueOptions = function(options) {
      var body, push, queue;
      body = {};
    ...
    prepareSubscribers = function(subscribers) {
      var values;
      values = _.map(subscribers, function(val) {
        return {
          url: val
        };
      });
