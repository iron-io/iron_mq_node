...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.msg_touch = function(message_id, reservation_id, cb) {
      return this.api.messagesTouch(this.api.options.queue_name, message_id, reservation_id, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
    ...
    Client.prototype.msg_release = function(message_id, reservation_id, options, cb) {
      return this.api.messagesRelease(this.api.options.queue_name, message_id, reservation_id, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
